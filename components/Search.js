Search = React.createClass({
    ...
    render: function() {
        ...
        return <input type="text" onChange={this.handleChange} onKeyUp={this.handleKeyUp} placeholder="Tutaj wpisz wyszukiwana fraze" style={styles} value={this.state.searchTerm}/>
    }
});
